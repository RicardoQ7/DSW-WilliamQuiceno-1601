function procesarRespuestas(){   // mi función 
    ...
    let myForm = document.forms["evaluacion5G"];                 // creo una variable que apunte al formulario (se llama evaluacion5G)
...
function procesarRespuestas(){   // mi función 
    ...
    let myForm = document.forms["evaluacion_selectores"];                 // creo una variable que apunte al formulario (se llama evaluacion5G)
    let respuestasCorrectas = ["b", "c", "a", "c", "b"];      // en esta variable, alojo las respuestas correctas de las 5 preguntas
